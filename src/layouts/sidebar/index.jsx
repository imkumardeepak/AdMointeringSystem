  ...
  const subMenusList = [
    {
      ...
      menus: ["Screen1", "Screen2", "Screen3", "Screen4"],
    },
    {
      name: "analytics",
    ...
    <div>
      ...
      >
        <div className="flex items-center gap-2.5 font-medium border-b py-3 border-slate-300  mx-3">
          <img
            src="https://img.icons8.com/?size=100&id=CTL6fNPxvJku&format=png&color=000000"
            width={45}
            alt=""
          />
          <span className="text-xl whitespace-pre">Remote Screen</span>
        </div>
