...
function useSelect(props) {
  ...
  const optionValues = React2.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React2.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React2.useCallback((valueToCheck) => {
    var _option$disabled;
    const option = getOptionByValue(valueToCheck);
    return (_option$disabled = option == null ? void 0 : option.disabled) != null ? _option$disabled : false;
  }, [getOptionByValue]);
  const stringifyOption = React2.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const controlledState = React2.useMemo(() => ({
    selectedValues: value,
    open: openProp
  }), [value, openProp]);
  const getItemId = React2.useCallback((itemValue) => {
    var _options$get;
    return (_options$get = options.get(itemValue)) == null ? void 0 : _options$get.id;
  }, [options]);
  const handleSelectionChange = React2.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React2.useCallback((event, newValue) => {
    onHighlightChange == null || onHighlightChange(event, newValue != null ? newValue : null);
  }, [onHighlightChange]);
  const handleStateChange = React2.useCallback((event, field, fieldValue) => {
    if (field === "open") {
  ...
  const getItemDomElement = React2.useCallback((itemId) => {
  ...
  const useListParameters = {
    ...
    reducerActionContext: React2.useMemo(() => ({
      multiple
    }), [multiple]),
    items: optionValues,
  ...
  const isInitiallyOpen = React2.useRef(open);
  useEnhancedEffect_default(() => {
  ...
  const getOptionMetadata = React2.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
  ...
  const contextValue = React2.useMemo(() => _extends({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
function SelectProvider(props) {
  ...
  const listContextValue = React3.useMemo(() => ({
    dispatch,
    getItemState,
    getItemIndex
  }), [dispatch, getItemIndex, getItemState]);
  const compoundComponentContextValue = React3.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
  ...
  return (0, import_jsx_runtime2.jsx)(CompoundComponentContext.Provider, {
    ...
    children: (0, import_jsx_runtime2.jsx)(ListContext.Provider, {
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = (_React$useContext = React15.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
  const isInitiallyOpen = React15.useRef(open);
  const {
    subitems,
    contextValue: compoundComponentContextValue
  } = useCompoundParent();
  const subitemKeys = React15.useMemo(() => Array.from(subitems.keys()), [subitems]);
  ...
  const reducerActionContext = React15.useMemo(() => ({
    listboxRef: rootRef
  }), [rootRef]);
  const {
...
var TransitionContext = React18.createContext(null);
if (true) {
...
function useTransitionStateManager() {
  const transitionContext = React19.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React20.useState(true);
  const hasPendingExitTransition = React20.useRef(false);
  const registeredTransitions = React20.useRef(0);
  const [hasTransition, setHasTransition] = React20.useState(false);
  const previousRequestEnter = React20.useRef(requestEnter);
  React20.useEffect(() => {
  ...
  const handleExited = React20.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React20.useCallback(() => {
...
var PopupContext = React21.createContext(null);
if (true) {
...
var Popup = React22.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children,
  ...
  const popupContextValue = React22.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
var Menu = React23.forwardRef(function Menu2(props, forwardedRef) {
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React24.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React25.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    slots = {},
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = (_React$useContext = React26.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
function useMenuItemContextStabilizer(id) {
  ...
  const localGetItemState = React27.useCallback((itemValue) => {
    if (itemValue !== itemId) {
  ...
  const localContextValue = React27.useMemo(() => ({
    dispatch,
...
var InnerMenuItem = React28.memo(React28.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
var MenuItem2 = React28.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
var Modal = React29.forwardRef(function Modal2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime18.jsx)(React30.Fragment, {
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React31.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React31.useMemo(() => {
    return {
      min,
      max,
      step,
  ...
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React31.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var NumberInput = React32.forwardRef(function NumberInput2(props, forwardedRef) {
...
var OptionGroup = React33.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {}
...
var InnerOption = React34.memo(React34.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React34.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
...
var Select = React35.forwardRef(function Select2(props, forwardedRef) {
...
var Slider = React37.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime27.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime26.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime26.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime27.jsxs)(React37.Fragment, {
...
var Snackbar = React39.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var Switch = React41.forwardRef(function Switch2(props, forwardedRef) {
...
var TablePaginationActions = React42.forwardRef(function TablePaginationActions2(props, forwardedRef) {
...
var TablePagination = React43.forwardRef(function TablePagination2(props, forwardedRef) {
...
function useTabs(parameters) {
  ...
  const onSelected = React44.useCallback((event, newValue) => {
    setValue(newValue);
  ...
  const tabIdLookup = React44.useRef(() => void 0);
  const getTabPanelId = React44.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React44.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React44.useCallback((lookupFunction) => {
...
var TabsContext = React45.createContext(null);
if (true) {
  TabsContext.displayName = "TabsContext";
}
function useTabsContext() {
  const context = React45.useContext(TabsContext);
  if (context == null) {
...
var Tabs = React47.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
function useTabPanel(parameters) {
  ...
  const metadata = React48.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
var TabPanel = React49.forwardRef(function TabPanel2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React50.useCallback((tabValue) => {
    var _subitems$get;
  ...
  const getTabElement = React50.useCallback((tabValue) => {
  ...
  const handleChange = React50.useCallback((event, newValue) => {
    var _newValue$;
    onSelected(event, (_newValue$ = newValue[0]) != null ? _newValue$ : null);
  }, [onSelected]);
  const controlledProps = React50.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React50.useCallback((item) => {
  ...
  const contextValue = React50.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
var TabsList = React52.forwardRef(function TabsList2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
function useTab(parameters) {
  ...
  const tabRef = React53.useRef(null);
  const id = useId(idParam);
  const {
    value: selectedValue,
    selectionFollowsFocus,
  ...
  const tabMetadata = React53.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var Tab = React54.forwardRef(function Tab2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled = false,
...
var TextareaAutosize = React55.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  return (0, import_jsx_runtime42.jsxs)(React55.Fragment, {
...
function CssAnimation(props) {
  ...
  const hasExited = React56.useRef(true);
  React56.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React56.useCallback((event) => {
...
var CssTransition = React57.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React57.useState(false);
  React57.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React57.useCallback((event) => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EZEBXC5X.js.map
