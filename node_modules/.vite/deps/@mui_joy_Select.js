...
} from "./chunk-XG4KREDS.js";
import {
  resolveSxValue
} from "./chunk-OEG6R2WG.js";
import {
  Popper,
  SelectProvider,
  useSelect
} from "./chunk-4ACTQH4U.js";
import "./chunk-6DWJOMHT.js";
import "./chunk-PFKJSAU2.js";
import "./chunk-6S5AI5GN.js";
import {
  useSlot
...
import {
  styled_default,
  useThemeProps
} from "./chunk-V63G7GW6.js";
import {
  generateUtilityClass,
  generateUtilityClasses
} from "./chunk-52EBXDQC.js";
import {
  _extends,
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime7.jsx)(React12.Fragment, {
...
var Select = React12.forwardRef(function Select2(inProps, ref) {
  ...
  const formControl = React12.useContext(FormControlContext_default);
  if (true) {
  ...
  const handleOpenChange = React12.useCallback((isOpen) => {
  ...
  const selectedOption = React12.useMemo(() => {
  ...
  const modifiers = React12.useMemo(() => [...defaultModifiers, ...listboxProps.modifiers || []], [listboxProps.modifiers]);
