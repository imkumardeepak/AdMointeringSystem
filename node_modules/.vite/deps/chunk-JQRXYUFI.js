...
function useSelect(props) {
  ...
  const optionValues = React3.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React3.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React3.useCallback((valueToCheck) => {
    var _option$disabled;
    const option = getOptionByValue(valueToCheck);
    return (_option$disabled = option == null ? void 0 : option.disabled) != null ? _option$disabled : false;
  }, [getOptionByValue]);
  const stringifyOption = React3.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const controlledState = React3.useMemo(() => ({
    selectedValues: value,
    open: openProp
  }), [value, openProp]);
  const getItemId = React3.useCallback((itemValue) => {
    var _options$get;
    return (_options$get = options.get(itemValue)) == null ? void 0 : _options$get.id;
  }, [options]);
  const handleSelectionChange = React3.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React3.useCallback((event, newValue) => {
    onHighlightChange == null || onHighlightChange(event, newValue != null ? newValue : null);
  }, [onHighlightChange]);
  const handleStateChange = React3.useCallback((event, field, fieldValue) => {
    if (field === "open") {
  ...
  const getItemDomElement = React3.useCallback((itemId) => {
  ...
  const useListParameters = {
    ...
    reducerActionContext: React3.useMemo(() => ({
      multiple
    }), [multiple]),
    items: optionValues,
  ...
  const isInitiallyOpen = React3.useRef(open);
  useEnhancedEffect_default(() => {
  ...
  const getOptionMetadata = React3.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
  ...
  const contextValue = React3.useMemo(() => _extends({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
function SelectProvider(props) {
  ...
  const listContextValue = React4.useMemo(() => ({
    dispatch,
    getItemState,
    getItemIndex
...
var Menu = React25.forwardRef(function Menu2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime16.jsx)(Popup, _extends({
    keepMounted: true
  }, rootProps, {
    open,
    anchor,
...
var MenuItem2 = React30.forwardRef(function MenuItem3(props, ref) {
  ...
  return (0, import_jsx_runtime18.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime18.jsx)(InnerMenuItem, _extends({}, props, {
      id,
      ref
    }))
  });
...
var NumberInput = React35.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime23.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime22.jsx)(DecrementButton, _extends({}, decrementButtonProps)), (0, import_jsx_runtime22.jsx)(IncrementButton, _extends({}, incrementButtonProps)), startAdornment, (0, import_jsx_runtime22.jsx)(Input3, _extends({}, inputProps)), endAdornment]
  }));
});
...
var InnerOption = React37.memo(React37.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React37.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
  ...
  return (0, import_jsx_runtime26.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime26.jsx)(InnerOption, _extends({}, props, {
      ref
    }))
  });
});
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime27.jsx)(React38.Fragment, {
...
var Select = React38.forwardRef(function Select2(props, forwardedRef) {
  ...
  const [buttonDefined, setButtonDefined] = React38.useState(false);
  ...
  const handleButtonRefChange = React38.useCallback((element) => {
...
var Slider = React40.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime30.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime29.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime29.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime30.jsxs)(React40.Fragment, {
...
var Snackbar = React42.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var Switch = React44.forwardRef(function Switch2(props, forwardedRef) {
...
var TablePaginationActions = React45.forwardRef(function TablePaginationActions2(props, forwardedRef) {
...
var TablePagination = React46.forwardRef(function TablePagination2(props, forwardedRef) {
...
function useTabs(parameters) {
  ...
  const onSelected = React47.useCallback((event, newValue) => {
    setValue(newValue);
  ...
  const tabIdLookup = React47.useRef(() => void 0);
  const getTabPanelId = React47.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React47.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React47.useCallback((lookupFunction) => {
...
function TabsProvider(props) {
  ...
  const tabsContextValue = React49.useMemo(() => ({
    direction,
    getTabId,
    getTabPanelId,
    onSelected,
...
var Tabs = React50.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
function useTabPanel(parameters) {
  ...
  const metadata = React51.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
function useTabsList(parameters) {
  ...
  const contextValue = React53.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
var TextareaAutosize = React58.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const calculateTextareaStyles = React58.useCallback(() => {
  ...
  return (0, import_jsx_runtime45.jsxs)(React58.Fragment, {
...
function CssAnimation(props) {
  ...
  const hasExited = React59.useRef(true);
  React59.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React59.useCallback((event) => {
...
var CssTransition = React60.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React60.useState(false);
  React60.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React60.useCallback((event) => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JQRXYUFI.js.map
